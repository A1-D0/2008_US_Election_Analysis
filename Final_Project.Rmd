...
Is the multiple regression model more effective in predicting the election result than the single regressions models?
...
Since there exists a linear relationship between the log(odds) and the predictor(s), the linearity condition is satisfied.
