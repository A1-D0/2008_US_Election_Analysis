...
# Hypothesis
We assume that political leaning is the most influential factor in predicting the election win, and the multiple logistic regression model will be the best model to predict the election win,
